...
The README visuals are generated by visual-architecture itself, from checked-in specs and receipts.

| Artifact engine | Source evidence | PR delta |
|---|---|---|
| [![Artifact engine workflow](examples/showcase-artifact-engine.svg)](examples/showcase-artifact-engine.html) | [![Source-evidence map](examples/showcase-repo-evidence.svg)](examples/showcase-repo-evidence.html) | [![PR delta review surface](examples/showcase-pr-delta.svg)](examples/showcase-pr-delta.html) |
| [`showcase-artifact-engine.json`](examples/showcase-artifact-engine.json) | [`showcase-repo-evidence.json`](examples/showcase-repo-evidence.json) | [`showcase-pr-delta.json`](examples/showcase-pr-delta.json) |
...
| Showcase artifact engine | [`showcase-artifact-engine.json`](examples/showcase-artifact-engine.json) | [`showcase-artifact-engine.svg`](examples/showcase-artifact-engine.svg) | [`showcase-artifact-engine.html`](examples/showcase-artifact-engine.html) | [`showcase-artifact-engine.html.receipt.json`](examples/showcase-artifact-engine.html.receipt.json) |
| Showcase repo evidence | [`showcase-repo-evidence.json`](examples/showcase-repo-evidence.json) | [`showcase-repo-evidence.svg`](examples/showcase-repo-evidence.svg) | [`showcase-repo-evidence.html`](examples/showcase-repo-evidence.html) | [`showcase-repo-evidence.html.receipt.json`](examples/showcase-repo-evidence.html.receipt.json) |
| Showcase PR delta | [`showcase-pr-delta.json`](examples/showcase-pr-delta.json) | [`showcase-pr-delta.svg`](examples/showcase-pr-delta.svg) | [`showcase-pr-delta.html`](examples/showcase-pr-delta.html) | [`showcase-pr-delta.html.receipt.json`](examples/showcase-pr-delta.html.receipt.json) |
